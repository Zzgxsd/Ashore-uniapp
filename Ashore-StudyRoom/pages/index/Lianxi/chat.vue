			...
			<view id="msglistview" class="chat-body">
				...
				<view v-for="(item,index) in msgList" :key="index">
					...
					<view class="item Ai" v-if="item.botContent != ''">
						<!-- 头像 -->
						<image class="avatar" :src="item.image" @click="zhuye">
						</image>
						<!-- 文字内容 -->
	...
	export default {
		data() {
			return {
				...
				msgList: [{
						...
						userContent: "",
						image: "../../../static/jiaoshi.jpg"
					},
					{
						botContent: "",
						userContent: "我想问问周末有位置吗?",
						image: "../../../static/me/touxiang.png"
					},
					{
						botContent: "周末有位置，可以预约哦！",
						userContent: "",
						image: "../../../static/jiaoshi.jpg"
					},
				]
		...
		methods: {
			...
			zhuye() {
				uni.navigateTo({
					//保留当前页面，跳转到应用内的某个页面
					url: '../../../pages/tabbar/tabbar-6/zhuye'
				})
			}
		}
	}
